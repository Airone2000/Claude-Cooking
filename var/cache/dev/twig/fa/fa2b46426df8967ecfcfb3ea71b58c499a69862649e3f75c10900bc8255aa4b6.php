...
class __TwigTemplate_31a8eac03764e3b79168a8e63c98c19e3c6a0539a0453bc185b6228b5b413a81 extends Twig_Template
{
    private $source;
    ...
    public function block_toolbar($context, array $blocks = array())
    {
        ...
        // line 19
        echo "    ";
        $context["has_time_events"] = (twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["collector"] ?? null), "events", array())) > 0);
        // line 20
        echo "
    ";
        // line 21
        $context["total_time"] = ((($context["has_time_events"] ?? null)) ? (sprintf("%.0f", twig_get_attribute($this->env, $this->source, ($context["collector"] ?? null), "duration", array()))) : ("n/a"));
        // line 22
        echo "    ";
        ...
        // line 23
        echo "    ";
        $context["status_color"] = (((($context["has_time_events"] ?? null) && (twig_get_attribute($this->env, $this->source, ($context["collector"] ?? null), "duration", array()) > 1000))) ? ("yellow") : (""));
        // line 24
        echo "
    ";
        // line 25
...
";
    ...
    ";
        ...
        if (twig_get_attribute($this->env, $this->source, ($context["profile"] ?? null), "parent", array())) {
            ...
            Sub-Request ";
            // line 119
            echo $this->extensions['Symfony\Bundle\WebProfilerBundle\Twig\WebProfilerExtension']->dumpData($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["profile"] ?? null), "getcollector", array(0 => "request"), "method"), "requestattributes", array()), "get", array(0 => "_controller"), "method"));
            echo "
            <small>
                ";
            // line 121
...
";
            // line 516
            echo $context["__internal_7c1e2815d5b392bbfd3493367dbb0a2ca154dd8d1070b71ee24898e948f70ace"]->macro_dump_events(($context["events"] ?? null));
            echo "
                    ]
                }
";
...
{% endmacro %}
", "@WebProfiler/Collector/time.html.twig", "/Users/Erwan/Documents/Travail/API Platform/Claude-Cooking/vendor/symfony/web-profiler-bundle/Resources/views/Collector/time.html.twig");
    }
}
