...
class __TwigTemplate_e6e629d5816ac0bcbbec65c17eba0189f2173fc2de04c209169167b85e52faa6 extends Twig_Template
{
    private $source;
    ...
    ";
        ...
        if (((twig_get_attribute($this->env, $this->source, ($context["collector"] ?? null), "forward", array(), "any", true, true)) ? (_twig_default_filter(twig_get_attribute($this->env, $this->source, ($context["collector"] ?? null), "forward", array()), false)) : (false))) {
            ...
            // line 17
            echo "            ";
            echo $context["helper"]->macro_set_handler(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["collector"] ?? null), "forward", array()), "controller", array()));
            echo "
        ";
    ...
    ";
        ...
        if (array_key_exists("forward_handler", $context)) {
            ...
            echo "
                        (<a href=\"";
            // line 91
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("_profiler", array("token" => twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["collector"] ?? null), "forward", array()), "token", array()))), "html", null, true);
            echo "\">";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["collector"] ?? null), "forward", array()), "token", array()), "html", null, true);
            echo "</a>)
                    </span>
                </div>
            </div>
...
{% macro set_handler(controller, route, method) %}
    ...
    {%- endif %}
{% endmacro %}
", "@WebProfiler/Collector/request.html.twig", "/Users/Erwan/Documents/Travail/API Platform/Claude-Cooking/vendor/symfony/web-profiler-bundle/Resources/views/Collector/request.html.twig");
    }
}
